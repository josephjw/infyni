...
class XDLiveClassUpcoming extends StatelessWidget {
  XDLiveClassUpcoming({
    Key key,
  }) : super(key: key);
  @override
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(121.5, 32.0, 110.0, 1.0),
                          size: Size(349.0, 33.0),
                          pinBottom: true,
                          fixedWidth: true,
                          fixedHeight: true,
...
const String _svg_yomvoi =
    '<svg viewBox="121.5 30.0 110.0 1.0" ><path transform="translate(121.5, 30.0)" d="M 0 0 L 110 0" fill="none" stroke="#da3b42" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
