...
class XDNewMessages extends StatelessWidget {
  XDNewMessages({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 349.0, 459.0),
                    size: Size(349.0, 459.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.0, 0.0, 29.0, 16.0),
                    size: Size(327.0, 57.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 29.0, 16.0),
                          size: Size(29.0, 16.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 56.0, 327.0, 1.0),
                    size: Size(327.0, 57.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(311.0, 28.0, 11.0, 8.0),
                    size: Size(327.0, 57.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.0, 26.0, 64.0, 16.0),
                    size: Size(327.0, 57.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.0, 0.0, 40.0, 16.0),
                    size: Size(327.0, 57.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.0, 26.0, 75.0, 16.0),
                    size: Size(327.0, 57.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(136.0, 17.0, 104.0, 21.0),
                    size: Size(375.0, 56.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
...
const String _svg_xnsbt4 =
    '<svg viewBox="25.0 159.0 327.0 1.0" ><path transform="translate(25.0, 159.0)" d="M 0 1 L 327 0" fill="none" stroke="#b2b2b2" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_kz6uoy =
    '<svg viewBox="13.0 131.0 349.0 336.0" ><path transform="translate(13.0, 467.0)" d="M 0 0 L 349 0" fill="none" stroke="#e5e5e5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 347.0, 139.0)" d="M 5.499999523162842 0 L 11 8 L 0 8 Z" fill="#767070" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_h6ytp4 =
    '<svg viewBox="25.0 155.0 327.0 1.0" ><path transform="translate(25.0, 155.0)" d="M 0 1 L 327 0" fill="none" stroke="#d6dde3" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_yazg20 =
    '<svg viewBox="336.0 127.0 11.0 8.0" ><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 347.0, 135.0)" d="M 5.499999523162842 0 L 11 8 L 0 8 Z" fill="#767070" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
