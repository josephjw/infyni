          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 349.0, 475.0),
                    size: Size(349.0, 475.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 119.0, 16.0),
                    size: Size(318.5, 36.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'Your Live class starting',
                      style: TextStyle(
                        fontFamily: 'Rubik',
                        fontSize: 12,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 20.0, 50.0, 16.0),
                    size: Size(318.5, 36.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(313.0, 16.0, 5.5, 9.1),
                    size: Size(318.5, 36.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 135.0, 16.0),
                    size: Size(135.0, 36.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                    child: Text(
                      'New Batch added for you',
                      style: TextStyle(
                        fontFamily: 'Rubik',
                        fontSize: 12,
                        color: const Color(0xff000000),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 20.0, 35.0, 16.0),
                    size: Size(135.0, 36.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 20.0, 105.0, 16.0),
                    size: Size(125.0, 36.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 99.0, 16.0),
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(13.0, 0.0, 36.0, 19.0),
                    size: Size(349.0, 31.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 31.0, 349.0, 1.0),
                    size: Size(349.0, 31.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(13.0, 8.0, 59.0, 19.0),
                    size: Size(349.0, 39.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 39.0, 349.0, 1.0),
                    size: Size(349.0, 39.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
...
const String _svg_8u4f4f =
    '<svg viewBox="0.0 -8.0 349.0 1.0" ><path transform="translate(0.0, -8.0)" d="M 0 0 L 349 0" fill="none" stroke="#e5e5e5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
