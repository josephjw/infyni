...
class XDLiveClass extends StatelessWidget {
  XDLiveClass({
    Key key,
  }) : super(key: key);
  @override
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.5, 32.0, 110.0, 1.0),
                          size: Size(349.0, 33.0),
                          pinLeft: true,
                          pinBottom: true,
                          fixedWidth: true,
...
const String _svg_y2rula =
    '<svg viewBox="0.5 30.0 110.0 1.0" ><path transform="translate(0.5, 30.0)" d="M 0 0 L 110 0" fill="none" stroke="#da3b42" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
