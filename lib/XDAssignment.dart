...
import 'package:infyni/onboard/Widgets/layout/gotile.dart';
import 'package:infyni/onboard/Widgets/layout/header.dart';

import 'onboard/Widgets/layout/drawer.dart';

class XDAssignment extends StatefulWidget {
  XDAssignment({
    Key key,
  }) : super(key: key);

  @override
  Assignment createState() => Assignment();
}
class Assignment extends State<XDAssignment> with SingleTickerProviderStateMixin {
...
child:            TabBarView(controller: _controller, children: [
      ...
      Gotile(),
                    ...
                    TabBar(
                        ...
                        indicatorColor:    const Color(0xfff33c3c),
                        tabs: [
                          ...
                          Tab(
                            child:  Text(
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                color:  _controller.index==1?const Color(0xff213574): const Color(0xff8a8a8b),
                          ...
                          Tab(
                            child:       Text(
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                color: _controller.index==2?const Color(0xff213574): const Color(0xff8a8a8b),
                                height: 1.2857142857142858,
                              ),
                              textAlign: TextAlign.right,
                            ),
          ...
          //   child:                // Adobe XD layer: 'Batch Row' (group)
          //       SizedBox(
          //     width: 320.0,
          //     height: 36.0,
          //     child: Stack(
          ...
          //         ),
          //         Pinned.fromSize(
          //           bounds: Rect.fromLTWH(49.0, 20.0, 79.0, 16.0),
          //           size: Size(320.5, 36.0),
          //           pinBottom: true,
          //           fixedWidth: true,
          //           fixedHeight: true,
          ...
          //         ),
          //         Pinned.fromSize(
          //           bounds: Rect.fromLTWH(315.0, 16.0, 5.5, 9.1),
          //           size: Size(320.5, 36.0),
          //           pinRight: true,
          //           fixedWidth: true,
          //           fixedHeight: true,
    ...
    //                 bounds: Rect.fromLTWH(52.0, 0.0, 54.0, 19.0),
    //                 size: Size(349.0, 33.0),
    //                 pinLeft: true,
    //                 pinTop: true,
    //                 fixedWidth: true,
    ...
    //   Tab(
    //       child:      Pinned.fromSize(
    //                 bounds: Rect.fromLTWH(244.0, 0.0, 60.0, 19.0),
    //                 size: Size(349.0, 33.0),
    //                 pinRight: true,
    //                 pinTop: true,
    //                 fixedWidth: true,
    ...
    //       // Adobe XD layer: 'status bar' (group)
          ...
          Header(text: 'Assignment',onTap: ()=>Navigator.of(context).pop(),),
